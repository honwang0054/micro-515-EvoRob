...
>>>>>>> a0099a5 (Add cluster submit files)
    ...
    def set_weights(self, encoding):
        ...
        self.input_to_hidden = np.reshape(encoding[:self.n_params_i2h], (self.n_hidden, self.n_input))
        self.hidden_to_output = np.reshape(encoding[self.n_params_i2h:], (self.n_output, self.n_hidden))
